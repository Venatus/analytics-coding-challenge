...
Wait ~60 seconds for all services to initialise. You'll see the URLs printed in the terminal.
...
Lightdash is pre-configured with an account and a project connected to ClickHouse via Trino. Just log in:
...
While exploring the data, you should notice at least one **anomalous pattern** that suggests a data quality or business integrity issue.
...
| 2 | Lightdash dashboard | Screenshots in `DESIGN.md` or live in Lightdash |
